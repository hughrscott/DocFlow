...
class DocumentAnalyzer:
    ...
    def _create_analysis_prompt(self) -> str:
        ...
        """
        prompt = (
            "You are a personal document organization assistant. Analyze the provided document image and return ONLY a single JSON object that matches the schema below. Do not include any prose, markdown, or additional text.\n\n"
            "Context:\n"
            "- Household documents plus two business locations for 'School of Rock': 'West University' (aka 'West U') and 'The Heights' (aka 'Heights').\n"
            "- Documents are often scanned mail; expect OCR noise, stamps, and fax artifacts. Use issuer name/logo, headings, reference lines, and page markers as high-signal anchors.\n\n"
            "Taxonomy for document_type.value (choose exactly one):\n"
            "banking: bank_statement, credit_card_statement, mortgage_statement, loan_document\n"
            "taxes: tax_bill, property_tax, income_tax\n"
            "utilities: utility_bill, electric_bill, gas_bill, water_bill, internet_bill, mobile_bill\n"
            ...
            "  \"business_context\": { \"brand\": string|null, \"location\": string|null, \"address\": string|null, \"phone\": string|null },\n"
            "  \"addresses\": { \"issuer\": string|null, \"recipient\": string|null },\n"
            ...
            "}\n\n"
            "Instructions:\n"
            "- Identify issuer and recipient. If a School of Rock entity appears, set account_type='business' and business_context.brand='School of Rock'.\n"
            "- If the location indicates 'West University'/'West U' or 'The Heights'/'Heights', set business_context.location accordingly.\n"
            "- Choose document_type.value strictly from the taxonomy; be conservative if ambiguous.\n"
            "- Extract period: prefer period.month (YYYY-MM); else end_date or start_date (YYYY-MM-DD).\n"
            "- Extract identifiers and mask account_last4 to last 4 digits only.\n"
            "- Continuation: set is_continuation_of_previous.value true if page markers (e.g., 'Page X of Y'), header/footer signatures, matching identifiers, or period strongly suggest continuation. Provide a brief rationale.\n"
            "- Propose a filename: <IssuerClean>-<DocType>-<YYYY-MM or YYYY-MM-DD><-LAST4?>-PageN.pdf (no spaces, hyphens).\n\n"
            "Examples (for guidance only; still return only a single JSON object for the provided image):\n"
            "Example A — Business invoice (School of Rock — The Heights):\n"
            "{\n"
            "  \"issuer\": { \"name\": \"Fender Musical Instruments\", \"confidence\": 0.9 },\n"
            "  \"recipient\": { \"name\": \"School of Rock - The Heights\", \"confidence\": 0.95 },\n"
            "  \"document_type\": { \"value\": \"invoice\", \"confidence\": 0.92 },\n"
            "  \"document_subtype\": \"parts-and-supplies\",\n"
            "  \"period\": { \"start_date\": null, \"end_date\": null, \"month\": \"2025-07\" },\n"
            "  \"identifiers\": { \"account_last4\": null, \"policy\": null, \"invoice\": \"FM-009221\", \"statement_id\": null },\n"
            "  \"amounts\": { \"total_due\": 412.50, \"balance\": null, \"payment\": null, \"currency\": \"USD\" },\n"
            "  \"addressed_to\": \"Studio, 123 E 20th St, Houston, TX\",\n"
            "  \"account_type\": \"business\",\n"
            "  \"business_context\": { \"brand\": \"School of Rock\", \"location\": \"The Heights\", \"address\": \"123 E 20th St, Houston, TX\", \"phone\": null },\n"
            "  \"addresses\": { \"issuer\": \"Fender, Scottsdale, AZ\", \"recipient\": \"123 E 20th St, Houston, TX\" },\n"
            "  \"is_continuation_of_previous\": { \"value\": false, \"confidence\": 0.85, \"rationale\": \"Standalone invoice\" },\n"
            "  \"page_markers\": { \"page_number_text\": \"Page 1 of 1\", \"total_pages_text\": \"of 1\" },\n"
            "  \"layout_fingerprints\": { \"fonts\": [\"Helvetica\"], \"header_signature\": \"fender-invoice-v1\", \"footer_signature\": \"fender-invoice-footer\" },\n"
            "  \"proposed_filename\": \"Fender-Musical-Instruments-Invoice-2025-07-Page1.pdf\",\n"
            "  \"hints\": [\"payable\"],\n"
            "  \"uncertainties\": []\n"
            "}\n\n"
            "Example B — Business internet bill (School of Rock — West University / West U):\n"
            "{\n"
            "  \"issuer\": { \"name\": \"Comcast Xfinity\", \"confidence\": 0.96 },\n"
            "  \"recipient\": { \"name\": \"School of Rock - West University\", \"confidence\": 0.93 },\n"
            "  \"document_type\": { \"value\": \"internet_bill\", \"confidence\": 0.94 },\n"
            "  \"document_subtype\": \"business-internet\",\n"
            "  \"period\": { \"start_date\": null, \"end_date\": null, \"month\": \"2025-08\" },\n"
            "  \"identifiers\": { \"account_last4\": \"5678\", \"policy\": null, \"invoice\": \"INV-884211\", \"statement_id\": \"STMT-2025-08\" },\n"
            "  \"amounts\": { \"total_due\": 129.99, \"balance\": null, \"payment\": null, \"currency\": \"USD\" },\n"
            "  \"addressed_to\": \"West U Studio, 5100 Westheimer Rd, Houston, TX\",\n"
            "  \"account_type\": \"business\",\n"
            "  \"business_context\": { \"brand\": \"School of Rock\", \"location\": \"West University\", \"address\": \"5100 Westheimer Rd, Houston, TX\", \"phone\": null },\n"
            "  \"addresses\": { \"issuer\": \"Comcast, Philadelphia, PA\", \"recipient\": \"5100 Westheimer Rd, Houston, TX\" },\n"
            "  \"is_continuation_of_previous\": { \"value\": false, \"confidence\": 0.9, \"rationale\": \"Complete first page\" },\n"
            "  \"page_markers\": { \"page_number_text\": \"Page 1 of 3\", \"total_pages_text\": \"of 3\" },\n"
            "  \"layout_fingerprints\": { \"fonts\": [\"Helvetica\", \"Arial\"], \"header_signature\": \"xfinity-stmt-topbar-v2\", \"footer_signature\": \"xfinity-footer-2024\" },\n"
            "  \"proposed_filename\": \"Comcast-Xfinity-Internet-Bill-2025-08-****5678-Page1.pdf\",\n"
            "  \"hints\": [\"recurring\"],\n"
            "  \"uncertainties\": []\n"
            "}\n\n"
            "Return only JSON."
